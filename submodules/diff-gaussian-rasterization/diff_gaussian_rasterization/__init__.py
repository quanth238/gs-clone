...
def rasterize_gaussians_with_stats(
    means3D,
    means2D,
    sh,
    colors_precomp,
    ...
    return _RasterizeGaussiansWithStats.apply(
        means3D,
        means2D,
        sh,
        colors_precomp,
...
class _RasterizeGaussiansWithStats(torch.autograd.Function):
    @staticmethod
    def forward(
        ctx,
        means3D,
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths, point_list, ranges, instance_mass = _C.rasterize_gaussians_with_stats(*args)
...
class GaussianRasterizerWithStats(nn.Module):
    def __init__(self, raster_settings):
        super().__init__()
        self.raster_settings = raster_settings
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None):
        ...
        return rasterize_gaussians_with_stats(
            means3D,
            means2D,
            shs,
            colors_precomp,
